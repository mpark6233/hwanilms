<?php  function wpbc_all_translations1() { $wpbc_all_translations = array(); 
 ...
 $wpbc_all_translations[] = __('Days selection in calendar', 'booking'); 
 $wpbc_all_translations[] = __('Use selected times for each booking date', 'booking'); 
 $wpbc_all_translations[] = __('Enable this option if you want to use the selected times as booked time slots on each selected date. Otherwise, the selected times will be used as the check-in time for the first date and check-out time for the last date of the reservation.', 'booking'); 
 $wpbc_all_translations[] = __('Allow multiple months to be shown on mobile', 'booking'); 
 $wpbc_all_translations[] = __('Enable this option to allow multiple months to be shown in the calendar on mobile devices. By default, the calendar only shows one month on mobile devices for easy scrolling.', 'booking'); 
 $wpbc_all_translations[] = __('Disable times in tooltips', 'booking'); 
 $wpbc_all_translations[] = __('Disable show booked times in tooltip, when mouse over specific day in calendar', 'booking'); 
 ...
 $wpbc_all_translations[] = __('Unavailable item', 'booking'); 
 $wpbc_all_translations[] = __('Unavailable', 'booking'); 
 $wpbc_all_translations[] = __('Activate and type your %stitle of unavailable%s item in legend', 'booking'); 
 ...
 $wpbc_all_translations[] = __('Show legend items in a column', 'booking'); 
 $wpbc_all_translations[] = __('Check this box to display legend items vertically in a column.', 'booking'); 
 $wpbc_all_translations[] = __('You can enable or disable, as well as configure %sTime Slots%s for your booking form on the Settings > %sBooking Form%s page.', 'booking'); 
 ...
 $wpbc_all_translations[] = __('Select a color theme for your booking form that matches the look of your website.', 'booking'); 
 $wpbc_all_translations[] = __('When you select a color theme, it also change the calendar and time-slot picker skins to match your choice. Customize these options separately as needed.', 'booking'); 
 $wpbc_all_translations[] = __('Light', 'booking'); 
 $wpbc_all_translations[] = __('Dark', 'booking'); 
 ...
 $wpbc_all_translations[] = __('If your website uses a cache plugin or system, exclude pages with booking forms from caching to ensure CAPTCHA functions correctly.', 'booking'); 
 ...
 $wpbc_all_translations[] = __('Pre-Check-in Display Duration', 'booking'); 
 $wpbc_all_translations[] = __('Select the number of days for the %s shortcode.', 'booking'); 
 $wpbc_all_translations[] = __('This shortcode is used in the booking form to display the date %sN days before%s the selected check-in date.', 'booking'); 
 $wpbc_all_translations[] = __('Show booking confirmation at same page', 'booking'); 
 $wpbc_all_translations[] = __('Redirect to thank you page', 'booking'); 
 $wpbc_all_translations[] = __('After  booking action:', 'booking'); 
 $wpbc_all_translations[] = __('Confirmation Page URL', 'booking'); 
 $wpbc_all_translations[] = __('This page should include the shortcode %s to display booking details and confirmation after a successful booking.', 'booking'); 
 $wpbc_all_translations[] = __('Your booking is received. We will confirm it soon. Many thanks!', 'booking'); 
 $wpbc_all_translations[] = __('Your booking is received. Please proceed with payment to confirm it. Many thanks!', 'booking'); 
 $wpbc_all_translations[] = __('Message title', 'booking'); 
 $wpbc_all_translations[] = __('Header', 'booking'); 
 $wpbc_all_translations[] = __('Enable', 'booking'); 
 $wpbc_all_translations[] = __('Your booking id: %s', 'booking'); 
 $wpbc_all_translations[] = __('Example', 'booking'); 
 $wpbc_all_translations[] = __('Personal information', 'booking'); 
 $wpbc_all_translations[] = __('Enter %stitle%s for this section of Booking Confirmation', 'booking'); 
 ...
 $wpbc_all_translations[] = __('PHP default timezone is invalid', 'booking'); 
 $wpbc_all_translations[] = __('Read more', 'booking'); 
 $wpbc_all_translations[] = __('Find additional details %shere%s', 'booking'); 
 $wpbc_all_translations[] = __('Server Default Timezone', 'booking'); 
 $wpbc_all_translations[] = __('WordPress Timezone', 'booking'); 
 ...
 $wpbc_all_translations[] = __('Booking Quantity Control', 'booking'); 
 $wpbc_all_translations[] = __('Enable this option to allow visitors to define the number of items they can book for specific dates or times within a single reservation. ', 'booking'); 
 $wpbc_all_translations[] = __('If disabled, visitors can book only one slot within a single reservation.', 'booking'); 
 $wpbc_all_translations[] = __('Quantity field name', 'booking'); 
 $wpbc_all_translations[] = __('Select the field that will control how many slots visitors can book during the reservation process.', 'booking'); 
 $wpbc_all_translations[] = __('Items', 'booking'); 
 ...
 $wpbc_all_translations[] = __('Parallel requests', 'booking'); 
 $wpbc_all_translations[] = __('Select the number of simultaneous requests to load data in multiple calendars.', 'booking'); 
 $wpbc_all_translations[] = __('Performance', 'booking'); 
 $wpbc_all_translations[] = __('This Server Balancer control how many parallel requests for loading calendar data can be sent at the same time. A lower number minimizes server impact but may increase the total time for loading all calendars.', 'booking'); 
 ...
 $wpbc_all_translations[] = __('Use Nonce Fields', 'booking'); 
 $wpbc_all_translations[] = __('Activate this option to add security tokens (nonce fields) to booking forms on the front-end. Please note that this may cause issues if you are using cache plugins or caching software.', 'booking'); 
 ...
 $wpbc_all_translations[] = __('Prices', 'booking'); 
 $wpbc_all_translations[] = __('Customize', 'booking'); 
 ...
 $wpbc_all_translations[] = __('Type your email %ssubject%s for the booking confirmation message.', 'booking'); 
 ...
 $wpbc_all_translations[] = __('Email Content', 'booking'); 
 $wpbc_all_translations[] = __('Help', 'booking'); 
 $wpbc_all_translations[] = __('Email Type', 'booking'); 
 ...
 $wpbc_all_translations[] = __('Enable Reply-To', 'booking'); 
 $wpbc_all_translations[] = __('Enable Reply-To visitor email', 'booking'); 
 ...
 $wpbc_all_translations[] = __('or newer', 'booking'); 
 ...
 $wpbc_all_translations[] = __('Append one check out day, during import .ics feeds', 'booking'); 
 ...
 $wpbc_all_translations[] = __('Remove Details in Google Calendar Export', 'booking'); 
 $wpbc_all_translations[] = __('Enable this option to exclude booking summary details when exporting to Google Calendar using the \'Add to Google Calendar\' button.', 'booking'); 
 ...
 $wpbc_all_translations[] = __('Import conditions', 'booking'); 
 $wpbc_all_translations[] = __('Import Only New Events', 'booking'); 
 $wpbc_all_translations[] = __('Import only if the event has not been imported before.', 'booking'); 
 $wpbc_all_translations[] = __('Import if Dates Available', 'booking'); 
 $wpbc_all_translations[] = __('Import only if dates are available in the source calendar.', 'booking'); 
 ...
 $wpbc_all_translations[] = __('Last import', 'booking'); 
 $wpbc_all_translations[] = __('during', 'booking'); 
 $wpbc_all_translations[] = __('Next import', 'booking'); 
 ...
 $wpbc_all_translations[] = __('Calendar Dates Tooltips', 'booking'); 
 $wpbc_all_translations[] = __('Form Options', 'booking'); 
 $wpbc_all_translations[] = __('Booking Confirmation', 'booking'); 
 $wpbc_all_translations[] = __('Section', 'booking'); 
 $wpbc_all_translations[] = __('Personal Information', 'booking'); 
 $wpbc_all_translations[] = __('Shortcodes', 'booking'); 
 $wpbc_all_translations[] = __('Bookings Options', 'booking'); 
 ...
 $wpbc_all_translations[] = __('Booking Quantity Control - Set limits for the number of bookings per day or time slot.', 'booking'); 
 $wpbc_all_translations[] = __('Information', 'booking'); 
 $wpbc_all_translations[] = __('Date : Time', 'booking'); 
 $wpbc_all_translations[] = __('Uninstall / deactivation', 'booking'); 
 $wpbc_all_translations[] = __('Tools', 'booking'); 
 ...
 $wpbc_all_translations[] = __('What\'s New', 'booking'); 
 $wpbc_all_translations[] = __('Request Update', 'booking'); 
 ...
 $wpbc_all_translations[] = __('Booking(s) for today', 'booking'); 
 $wpbc_all_translations[] = __('for', 'booking'); 
 $wpbc_all_translations[] = __('Options', 'booking'); 
 $wpbc_all_translations[] = __('Calendar View', 'booking'); 
 ...
 $wpbc_all_translations[] = __('Maximum width of calendar', 'booking'); 
 ...
 $wpbc_all_translations[] = __('Reset keyword text field', 'booking'); 
 ...
 $wpbc_all_translations[] = __('Tooltips in days', 'booking'); 
 $wpbc_all_translations[] = __('Manage Bookings', 'booking'); 
 $wpbc_all_translations[] = __('Auto Cancellation / Auto Approval', 'booking'); 
 $wpbc_all_translations[] = __('Admin Panel', 'booking'); 
 $wpbc_all_translations[] = __('Date / Time Formats', 'booking'); 
 $wpbc_all_translations[] = __('Plugin Menu / Permissions', 'booking'); 
 $wpbc_all_translations[] = __('Info / News', 'booking'); 
 $wpbc_all_translations[] = __('Show All Settings', 'booking'); 
 $wpbc_all_translations[] = __('Help Info', 'booking'); 
 $wpbc_all_translations[] = __('feature', 'booking'); 
 $wpbc_all_translations[] = __('You must not deactivate loading BootStrap files at advanced section of these settings!', 'booking'); 
 $wpbc_all_translations[] = __('Show booking confirmation message', 'booking'); 
 $wpbc_all_translations[] = __('Type title of message %safter booking has done by user%s', 'booking'); 
 $wpbc_all_translations[] = __('Theme of booking admin panel', 'booking'); 
 $wpbc_all_translations[] = __('Select theme of your booking admin panel', 'booking'); 
 $wpbc_all_translations[] = __('Modern Theme', 'booking'); 
 $wpbc_all_translations[] = __('Legacy Theme', 'booking'); 
 ...
 $wpbc_all_translations[] = __('Customize fields in booking form', 'booking'); 
 $wpbc_all_translations[] = __('Free vs Pro', 'booking'); 
 ...
 $wpbc_all_translations[] = __('Help Tips', 'booking'); 
 $wpbc_all_translations[] = __('Select a dark color theme in Form Options on the Settings General page', 'booking'); 
 ...
 $wpbc_all_translations[] = __('Oops!', 'booking'); 
 $wpbc_all_translations[] = __('We could not find your booking. The link you used may be incorrect or has expired. If you need assistance, please contact our support team.', 'booking'); 
 ...
 $wpbc_all_translations[] = __('This page can only be accessed through links in emails related to your booking.', 'booking'); 
 ...
 $wpbc_all_translations[] = __('Imported from %s ', 'booking'); 
 $wpbc_all_translations[] = __('Event', 'booking'); 
 ...
 $wpbc_all_translations[] = __('%s - inserting URL for export booking to', 'booking'); 
 ...
 $wpbc_all_translations[] = __('Download translation PO files from %s and update the current translation version.', 'booking'); 
 $wpbc_all_translations[] = __('Show exist translations status', 'booking'); 
 ...
 $wpbc_all_translations[] = __('Booking Prices', 'booking'); 
 ...
 $wpbc_all_translations[] = __('Get Pro', 'booking'); 
 $wpbc_all_translations[] = __('Action is not allowed!', 'booking'); 
 $wpbc_all_translations[] = __('yes', 'booking'); 
 $wpbc_all_translations[] = __('no', 'booking'); 
 $wpbc_all_translations[] = __('Days Availability', 'booking'); 
 $wpbc_all_translations[] = __('Season Availability', 'booking'); 
 $wpbc_all_translations[] = __('Seasons', 'booking'); 
 $wpbc_all_translations[] = __('General Availability', 'booking'); 
 ...
 $wpbc_all_translations[] = __('Y_E_S', 'booking'); 
 $wpbc_all_translations[] = __('N_O', 'booking'); 
 ...
 $wpbc_all_translations[] = __('Start by using the %spre-configured booking page%s we have set up.', 'booking'); 
 $wpbc_all_translations[] = __('%sIntegrate booking form%s into a page on your website in just a few clicks.', 'booking'); 
 $wpbc_all_translations[] = __('Learn how to %sAdd the Booking Form or Calendar to your page%s in WordPress Block Editor, Elementor, or other non-standard editors.', 'booking'); 
 $wpbc_all_translations[] = __('See %sall shortcodes%s of the Booking Calendar that you can use in pages.', 'booking'); 
 $wpbc_all_translations[] = __('Next Steps', 'booking'); 
 $wpbc_all_translations[] = __('Start creating %snew bookings%s from %syour page%s or in the %sAdmin Panel%s.', 'booking'); 
 $wpbc_all_translations[] = __('Check %sBooking Listing%s page for new bookings.', 'booking'); 
 $wpbc_all_translations[] = __('Configure  %sForm Fields%s, %sEmails%s and other %sSettings%s.', 'booking'); 
 ...
 $wpbc_all_translations[] = __('Use "Check In" date as available in calendar for booking resources with capacity higher than 1 for search results', 'booking'); 
 $wpbc_all_translations[] = __('Use "Check Out" date as available in calendar for booking resources with capacity higher than 1 for search results', 'booking'); 
 ...
 $wpbc_all_translations[] = __('%s - default selection number of items, ', 'booking'); 
 $wpbc_all_translations[] = __('Example: %s - custom number of items selections"', 'booking'); 
 ...
 $wpbc_all_translations[] = __('Discounts applied', 'booking'); 
 ...
 $wpbc_all_translations[] = __('Check this box to display booking details with a tooltip, when mouse hovers over each day on the usual month calendar(s).', 'booking'); 
 ...
 $wpbc_all_translations[] = __('Customize costs based on form fields selections.', 'booking'); 
 ...
 $wpbc_all_translations[] = __('Total booking cost shortcode, which possible to use only for fields, which show some cost hint, but do not apply to total booking cost.', 'booking'); 
 $wpbc_all_translations[] = __('Set Deposit', 'booking'); 
 $wpbc_all_translations[] = __('Partial Payments', 'booking'); 
 ...
 $wpbc_all_translations[] = __('Seasonal Pricing', 'booking'); 
 ...
 $wpbc_all_translations[] = __('Duration-Based Costs', 'booking'); 
