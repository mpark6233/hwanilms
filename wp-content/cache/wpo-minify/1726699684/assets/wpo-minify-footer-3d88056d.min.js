...
var SGPB_JS_PARAMS = {"url":"https:\/\/www.hwanil.ms.kr\/wp-admin\/admin-ajax.php","nonce":"e050414f9a"};
function SGPBBanner(){}
SGPBBanner.prototype.init=function(){this.callFeedbackPopup();this.closeFeedbackPopup();this.close();this.closeLicenseNotice()};SGPBBanner.prototype.closeFeedbackPopup=function(){if(!jQuery('#sgpb-feedback-popup').length){return}
...
jQuery('#sgpb-feedback-popup .sgpb-subscriber-data-popup-close-btn-js').bind('click',function(){hideFeedbackPopup()});document.onkeydown=function(e){e=e||window.event;if(e.keyCode===27){hideFeedbackPopup()}}};SGPBBanner.prototype.callFeedbackPopup=function(){if(!jQuery('#sgpb-feedback-popup').length){return}
