...
function kboard_comments_execute(form){jQuery.fn.exists=function(){return this.length>0};if(jQuery(form).data('submitted')){alert(kboard_comments_localize_strings.please_wait);return!1}
if(jQuery('input[name=member_display]',form).exists()&&!jQuery('input[name=member_display]',form).val()){alert(kboard_comments_localize_strings.please_enter_the_author);jQuery('[name=member_display]',form).focus();return!1}else if(jQuery('input[name=password]',form).exists()&&!jQuery('input[name=password]',form).val()){alert(kboard_comments_localize_strings.please_enter_the_password);jQuery('input[name=password]',form).focus();return!1}else if(jQuery('input[name=captcha]',form).exists()&&!jQuery('input[name=captcha]',form).val()){alert(kboard_comments_localize_strings.please_enter_the_CAPTCHA);jQuery('input[name=captcha]',form).focus();return!1}
jQuery(form).data('submitted','submitted');return!0}
...
return!1}
function kboard_comments_open_confirm(url){var width=500;var height=250;window.open(url,'kboard_comments_password_confirm','top='+(screen.availHeight*0.5-height*0.5)+',left='+(screen.availWidth*0.5-width*0.5)+',width='+width+',height='+height+',resizable=0,scrollbars=1');return!1}
function kboard_comments_open_edit(url){var width=500;var height=250;window.open(url,'kboard_comments_edit','top='+(screen.availHeight*0.5-height*0.5)+',left='+(screen.availWidth*0.5-width*0.5)+',width='+width+',height='+height);return!1}
function kboard_comments_reply(obj,form_id,cancel_id,content_uid){var parents=jQuery(obj).parents('#kboard-comments-'+content_uid);if(jQuery(obj).hasClass('kboard-reply-active')){jQuery(cancel_id).append(jQuery('.kboard-comments-form',parents));jQuery('.kboard-reply',parents).text(kboard_comments_localize_strings.reply).removeClass('kboard-reply-active')}else{jQuery(form_id).append(jQuery('.kboard-comments-form',parents));jQuery('textarea[name=comment_content]',parents).focus();jQuery('.kboard-reply',parents).text(kboard_comments_localize_strings.reply).removeClass('kboard-reply-active');jQuery(obj).text(kboard_comments_localize_strings.cancel).addClass('kboard-reply-active')}
if(typeof tinyMCE!=='undefined'&&tinyMCE.activeEditor){tinyMCE.EditorManager.execCommand('mceFocus',!1,'comment_content_'+content_uid);tinyMCE.EditorManager.execCommand('mceRemoveEditor',!0,'comment_content_'+content_uid);tinyMCE.EditorManager.execCommand('mceAddEditor',!0,'comment_content_'+content_uid)}
return!1}
